...
![Compression Ratio as a function of $m$ and $\sigma$ for Gaussian distributions using Rice Coding. Locations marked with $\star$ represent the best compression for that $\sigma$ value. The cutoff value $c$ was not utilized during this optimization](https://github.com/david-mathews-1994/deltarice/blob/master/paper/CompressionRatioPlot.png)
