...
![Example algorithms for the preparatory encoding operation. Depending on what hardware these routines are deployed on, there may be more efficient implementations \label{fig:EncodeDecode}.](EncodeDecodeAlgorithm.png){width="2in"}
